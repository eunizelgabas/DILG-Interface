<x-app-layout>
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="p-6 space-y-6">
            <form  method="POST" action="{{route('joint.update', $joint->id)}}">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="date" name="date" id="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"  value="{{ old('joint', $joint->issuance->date) }}">
                        @error('date')
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="title" name="title" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" required="">{{ old('joint', $joint->issuance->title) }}</textarea>
                        @error('title')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="reference_no" id="reference_no" value="{{ old('joint', $joint->issuance->reference_no) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" >
                        @error('reference_no')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="col-span-full">
                        ...
                        <input type="text" name="responsible_office" id="responsible_office" value="{{ old('joint', $joint->responsible_office) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                    ...
                    <div class="col-span-full">
                        ...
                        <input type="text" name="url_link" id="url_link" value="{{ old('joint', $joint->issuance->url_link) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                        @error('url_link')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
