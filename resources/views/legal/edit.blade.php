<x-app-layout>
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            ...
            <a href="/legal_opinions" type="button" class="text-gray-400 bg-transparent hover:bg-red-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="product-modal">
