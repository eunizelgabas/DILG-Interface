    ...
    <div class='flex items-center mt-3'>
        ...
        <div class="flex w-full items-center justify-between border-b pb-3">
          <div class="flex items-center space-x-3">
            ...
            <div class="text-ml font-bold text-slate-700">Reference No: <span class="font-light">{{$joint->issuance->reference_no}}</span></div>
          </div>
          <div class="flex items-center space-x-8">
            <div class="text-xs text-neutral-500">{{ \Carbon\Carbon::parse($joint->issuance->date)->format('F j, Y') }}</div>
            <div x-data="{ dropdownOpen: false }" class="relative">
                ...
                <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                    <a  href="{{ url('/joint_circulars/edit', $joint->id) }}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                       Edit
                    </a>
        ...
        <div class="mt-4 mb-">
          ...
          <div class="text-sm text-neutral-600 font-bold">Responsible Office: <span class="font-light">{{$joint->responsible_office}}</span></div>
          <div class="flex-1 inline-flex items-center">
            ...
            <a href="{{ $joint->issuance->url_link }}" class="font-bold ml-1 hover:underline" target="_blank">
             <span class=" text-blue-500 font-light">{{ $joint->issuance->url_link }}</span>
            </a>
        </div>
        </div>
          ...
          <div class="flex items-center justify-between text-slate-500">
            <div class="flex space-x-4 md:space-x-8">
              <div class="flex cursor-pointer items-center transition hover:text-slate-600">
                ...
                <span class="ml-2"> {{$joint->issuance->keyword}}</span>
              </div>
