            ...
            <form  method="POST" action="{{route('presidential.update', $presidential->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="date" name="date" id="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" value="{{ old('presidential', $presidential->issuance->date) }}">
                        @error('date')
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="title" name="title" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" required="">{{ old('presidential', $presidential->issuance->title) }}</textarea>
                        @error('title')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="reference_no" id="reference_no" value="{{ old('presidential', $presidential->issuance->reference_no) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" >
                        @error('reference_no')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <input type="text" name="url_link" id="url_link" value="{{ old('presidential', $presidential->issuance->url_link) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" >
                        @error('url_link')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                        @enderror
                    </div>
