    ...
    <div class="w-full max-w-[1190px] px-6 sm:px-8 md:px-16 py-2 md:py-10 rounded-xl min-h-[300px] m-2">
        <div class="flex flex-col md:flex-row items-start md:items-center">
            <div class="md:mr-4"> <!-- Adjust margin based on your design -->
                <h1 class="font-semibold text-2xl mb-2 tracking-wider drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">Latest Issuances Archive</h1>
                ...
                <div class='flex items-center mt-3'>
                    ...
                    <div class="flex w-full items-center justify-between border-b pb-3">
                      <div class="flex items-center space-x-3">
                        ...
                        <div class="text-ml font-bold text-slate-700">Reference No: <span class="font-light">{{$lat->issuance->reference_no}}</span></div>
                      </div>
                      <div class="flex items-center space-x-8">
                        <div class="text-xs text-neutral-500">{{ \Carbon\Carbon::parse($lat->issuance->date)->format('F j, Y') }}</div>
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            ...
                            <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                                ...
                                <a onclick="openDeleteModal({{ $lat->id }})" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-red-500 hover:text-white">
                                    Delete
                                </a>
                            </div>
                                ...
                                <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        ...
                                        <div class="flex  justify-center">
                                            <form id="deleteForm" method="POST" action="{{ url('/latest_issuances'. $lat->id) }}">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="mt-4 mb-">
                      ...
                      <div class="flex-1 inline-flex items-center">
                        ...
                        <a href="{{ $lat->issuance->url_link }}" class="font-bold ml-1 hover:underline" target="_blank">
                      ...
                      <div class="flex items-center justify-between text-slate-500">
                        <div class="flex space-x-4 md:space-x-8">
                          <div class="flex cursor-pointer items-center transition hover:text-slate-600">
                            ...
                            <span class="ml-2"> {{$lat->issuance->keyword}}</span>
                          </div>
 ...
 <script>
   document.addEventListener('DOMContentLoaded', function () {
    ...
    function openDeleteModal(id) {
        if (confirm("Are you sure you want to delete this Latest Issuance?")) {
            const form = document.getElementById('deleteForm');
            form.action = `{{ url('/latest_issuances') }}/${id}`;
            form.submit();
        }
    }
</script>
