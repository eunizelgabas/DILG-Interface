                        ...
                        <tr >
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <a href="{{ url('/users/show', $user->id) }}" type="button" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none ml-2">View Details</a>
                                </div>
                            </td>
