<div class="overflow-y-auto overflow-x-hidden flex-grow">
    <ul class="flex flex-col py-2 space-y-1">
        ...
        <li class="text-white border-transparent">
            <a href="/dashboard" class="nav-link relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100  hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6">
        ...
        <li class="text-white border-transparent border-indigo-900" >
            <a href="/users" class="nav-link relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100  hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li  class=" text-whiteborder-transparent border-indigo-900  ">
                <a  href="/logs" class=" nav-link relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100  hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <li  class=" text-whiteborder-transparent border-indigo-900  ">
                <a href="/visitors" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                      </svg>
                    <span class="text-base leading-4" >Visit Counter</span>
                </a>
            </li>
            ...
            <li>
                <div>
                    ...
                    <div  class="flex justify-start ml-3 flex-col w-full md:w-auto items-start pb-1 ">
                        <a  href="/latest_issuances" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                            </svg>
                            <span class="text-base leading-4" >Latest Issuances</span>
                        </a>
                        <a  href="/joint_circulars" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a  href="/memo_circulars" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="/presidential_directives" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <a href="/draft_issuances" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                            </svg>
                            <span class="text-base leading-4" >Draft Issuances</span>
                        </a>
                        <a href="/republic_acts"  class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            ...
                            <span class="text-base leading-4">Republic Acts</span>
                        </a>
                        <a href="/legal_opinions" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-blue-500 pr-6 rounded px-3 py-2 w-full nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<style scoped>
    .nav-link.active {
        background-color: #4299e1; /* Replace with your desired color */
        color: #ffffff; /* Replace with your desired color */
        border-color: #4299e1; /* Replace with your desired color */
    }
</style>
<script>
