            ...
            <form  method="POST" action="{{route('joint.update', $joint->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="date" name="date" id="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="" value="{{ old('joint', $joint->issuance->date) }}">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="reference_no" id="reference_no" value="{{ old('joint', $joint->issuance->reference_no) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    </div>
                    <div class="col-span-full">
