    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            <h3 class="text-xl font-semibold">
                Edit Memo Circular Details
            </h3>
            <a href="/memo_circulars" type="button" class="text-gray-400 bg-transparent hover:bg-red-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="product-modal">
            ...
            <form  method="POST" action="{{route('memo.update', $memo->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="date" id="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="" value="{{ old('memo', $memo->issuance->date) }}">
                    </div>


                    <div class="col-span-full">
                        <label for="title" class="text-sm font-medium text-gray-900 block mb-2">Title</label>
                        <textarea id="title" name="title" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" >{{ old('memo', $memo->issuance->title) }}</textarea>
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        <label for="reference_no" class="text-sm font-medium text-gray-900 block mb-2">Reference No</label>
                        <input type="text" name="reference_no" id="reference_no" value="{{ old('memo', $memo->issuance->reference_no) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    </div>
                    <div class="col-span-full">
                    ...
                    <div class="col-span-full">
                        ...
                        <input type="text" name="url_link" id="url_link" value="{{ old('memo', $memo->issuance->url_link) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    ...
                    <div id="keyword-container" class="col-span-full">
                        ...
                        <div class="flex mb-2" id="initial-input">
                            <input type="text" name="keyword[]" placeholder="" value="{{ old('memo', $memo->issuance->keyword) }}"
