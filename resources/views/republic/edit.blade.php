<x-app-layout>
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            ...
            <a href="/republic_circulars" type="button" class="text-gray-400 bg-transparent hover:bg-red-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="product-modal">
            ...
            <form  method="POST" action="{{route('republic.update', $republic->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="title" name="title" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" >{{ old('republic', $republic->issuance->title) }}</textarea>
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        <label for="reference_no" class="text-sm font-medium text-gray-900 block mb-2">Reference No</label>
                        <input type="text" name="reference_no" id="reference_no" value="{{ old('republic', $republic->issuance->reference_no) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    </div>
                    <div class="col-span-full">
                        <label for="responsible_office" class="text-sm font-medium text-gray-900 block mb-2">Responsible Office</label>
                        <input type="text" name="responsible_office" id="responsible_office" value="{{ old('republic', $republic->responsible_office) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    </div>
                    <div class="col-span-full">
                        <label for="url_link" class="text-sm font-medium text-gray-900 block mb-2">Url Link</label>
                        <input type="text" name="url_link" id="url_link" value="{{ old('republic', $republic->issuance->url_link) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    ...
                    {{-- <div id="keyword-container" class="col-span-full">
                        ...
                        <input type="text" name="keyword[]" value="{{ old('republic', $republic->issuance->keyword) }}" class=" keyword-input shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                        @error('keyword')
                ...
                <div class="p-6 border-t mt-5 border-gray-200 rounded-b flex justify-end">
                    <a href="/republic_circulars" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 mr-3 focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" >Cancel</a>
