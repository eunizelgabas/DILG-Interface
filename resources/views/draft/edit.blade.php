    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            <h3 class="text-xl font-semibold">
                Edit Draft Issuance Details
            </h3>
            <a href="/draft_issuances" type="button" class="text-gray-400 bg-transparent hover:bg-red-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="product-modal">
            ...
            <form  method="POST" action="{{route('draft.update', $draft->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <input type="text" name="date" id="date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="" value="{{ old('draft', $draft->issuance->date) }}">
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <input type="text" name="responsible_office" id="responsible_office" value="{{ old('draft', $draft->responsible_office) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required="">
                    </div>
                    <div class="col-span-full">
                    ...
                    <div id="keyword-container" class="col-span-full">
                        ...
                        <div class="flex mb-2" id="initial-input">
                            <input type="text" name="keyword[]" placeholder="" value="{{ old('draft', $draft->issuance->keyword) }}"
                ...
                <div class="p-6 border-t mt-5 border-gray-200 rounded-b flex justify-end">
                    <a href="/draft_circulars" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 mr-3 focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" >Cancel</a>
