    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            <h3 class="text-xl font-semibold">
                Edit legal Issuance Details
            </h3>
            <a href="/legal_issuances" type="button" class="text-gray-400 bg-transparent hover:bg-red-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="product-modal">
        ...
        <div class="p-6 space-y-6">
            <form  method="POST" action="{{route('legal.update', $legal->id)}}">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div id="keyword-container" class="col-span-full">
                        ...
                        <div class="flex mb-2" id="initial-input">
                            <input type="text" name="keyword[]" placeholder="" value="{{ old('legal', $legal->issuance->keyword) }}"
                ...
                <div class="p-6 border-t mt-5 border-gray-200 rounded-b flex justify-end">
                    <a href="/legal_opinions" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 mr-3 focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" >Cancel</a>
